...
namespace WebApplication2.Controllers
{
    public class ReviewController : Controller
    {
        ...
        public ReviewController(IBookClubContext context)
        {
            db = context;
        }
        ...
        {
            ViewBag.BookISBN = new SelectList(db.Books, "BookISBN", "BookName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ReviewID,UserID,BookISBN,Rating,Comment")] Review review)
        {
            ...
            ViewBag.BookISBN = new SelectList(db.Books, "BookISBN", "BookName", review.BookISBN);
            return View(review);
        }
